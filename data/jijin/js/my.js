						...
						fragment.appendChild(oLi);
			 			...
			 			for (var i = data.fund_list.data.length - 1; i >= 0; i--) {
			 				...
			 				oLi.innerHTML = '<div class="mui-media-body clear">'+
																...
																'<p class="clear" style="height:21px;">名称:'+data.fund_list.data[i].fundname+'('+data.fund_list.data[i].fundcode+')<span style="float:right;color:red;margin-right:-75px;">'+data.fund_list.data[i].riskDes+'</span></p>'+
