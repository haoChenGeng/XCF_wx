...
//select改变时获取选中option值
//$('select').change(function() {
//	var $changeValue = $(this).find('option:selected').val();
//	$('#deptClassify').attr('data-option',$changeValue);
//});
...
/*    var temp = document.createElement("form");
	...
	var $dataOption = $('#deptClassify').attr('data-option'),
	$selectid1 = $('#select-id1').val()?$('#select-id1').val():null,
	$selectid2 = $('#select-id2').val()?$('#select-id2').val():null,
	$selectid3 = $('#select-id3').val()?$('#select-id3').val():null,
	$accessUrl = $('#accessUrl').val();	
	
    var opt0 = document.createElement("textarea");        
    opt0.name = 'a';        
    opt0.value = $dataOption;        
    temp.appendChild(opt0); 
    var opt1 = document.createElement("input");
    opt1.name = 'b';        
    opt1.value = $selectid1; 
    temp.appendChild(opt1);
    var opt2 = document.createElement("textarea");        
    opt2.name = 'c';        
    opt2.value = $selectid2;        
    temp.appendChild(opt2);
    var opt3 = document.createElement("textarea");        
    opt3.name = 'd';        
    opt3.value = $selectid3;        
