...
<!-- <div id="error_t"><img src="<?php if($msgTy == 'fail') echo ($base."/data/img/error.png"); else echo ($base."/data/img/sess.png");?>"></div> -->
    ...
    <form  name="form" method="post" action="/jijin/Jz_account/open_phone_trans" id="login_form">
		<p class="affis"><input class="affis" type="submit" style="color: -webkit-link"value="如需开通手机交易，请点击这里"></input></p>
	</form>	    
        <p class="affis"><a href="<?php echo $msgUrl;?>">返回</a></p>
    </div>
</div>
</body>
</html>
